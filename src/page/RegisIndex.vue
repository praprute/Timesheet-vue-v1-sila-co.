    ...
    <b-form  v-if="show">
      ...
      <b-form-group id="input-group-5">
        <b-form-checkbox-group v-model="form.checked" id="checkboxes-5">
          <b-form-checkbox value="checkSuccess">
...
export default {
    ...
    methods:{
        fetchPartner(){
            ...
            axios
                .post(" http://localhost:3020/fetchPartner",{
        ...
        onSubmit(){
            if(this.form.checked[0] == "checkSuccess"){
                const token =  this.$store.state.store_token
            axios
                .post("http://localhost:3020/regisIndex",{
                    idUser: this.$store.state.store_userId,
                    date:this.form.date,
                    time:this.form.valueTime,
